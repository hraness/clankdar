/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.jsonc cloudflare/src/worker-configuration.d.ts` (hash: ec15f8657f9dfb7d0a9b172edf84960d)
