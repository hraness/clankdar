/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.jsonc cloudflare/src/worker-configuration.d.ts` (hash: 67a6fb89ff63fdf53fe0f8aabae1f3fe)
...
interface __BaseEnv_Env {
	...
	ACTORS: DurableObjectNamespace<import("./index").ActorState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "ActorState";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "MAX_BODY_BYTES" | "HEARTBEAT_MIN_SECONDS">> {}
}
